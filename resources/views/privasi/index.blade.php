                                ...
                                <div id="nav_menu-5" class="rb-section clearfix widget_nav_menu">
                                    ...
                                    <div class="menu-more-2-container">
                                        <ul id="menu-more-2" class="menu">
                                            ...
                                            <li id="menu-item-1745" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1745">
                                                <a href="#"><span>Children</span></a>
                                            </li>
                                            <li id="menu-item-1746" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1746">
                    ...
                    <div class="collapse-footer">
                        <div class="collapse-footer-menu">
                            <ul id="menu-footer-copyright" class="collapse-footer-menu-inner">
                                <li id="menu-item-1643" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1643">
                    ...
                    <div class="rb-container edge-padding">
                        <article id="post-1599" class="post-1599 post type-post status-publish format-standard has-post-thumbnail category-gadget tag-opinions tag-smartphone tag-top-10" itemscope itemtype="https://schema.org/Article">
                            <header class="single-header">
                                ...
                                <h3 class="s-title fw-headline" itemprop="headline">
                            ...
                            <div class="navbar-right">
                                                    {{-- <div class="hubungi kami">
                                                        <a href="{{ url('tambah berita') }}" class="is-btn header-element"><span>Kembali</span>
                                                        </a>
                                                    </div> --}}
                                                </div>
