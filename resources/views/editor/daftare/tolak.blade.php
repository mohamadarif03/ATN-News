                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Tolak Berita</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <form action="/fungsitolak/{{ $data->id }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        <div class="card-box">
                                            
                                        <div class="my-3 p-3 bg-body rounded shadow-sm">
                                            <div class="mb-3 row">
                                                <label for="jenis" class="col-sm-2 col-form-label">Judul</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name='judul' disabled value="{{$data->judul}}">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
