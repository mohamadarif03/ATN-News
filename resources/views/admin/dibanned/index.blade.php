...
<head>
    <meta charset="utf-8" />
    <title>Daftar Banned | ATN News - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Daftar Banned</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Daftar Banned</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($data as $row)
                                                            <tr>
                                                                ...
                                                                <td>{{ $row->Role->name }}</td>
                                                                <td>
                                                                    <form onsubmit="return confirm('Yakin Ingin Rebanned Pengguna Ini?')" class="d-inline" action="/rebanned/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                                                                        @csrf
                                                                        <button type="submit" style="color: white;" name="submit"
                                                                            class="btn btn-success"><i class="mdi mdi-account-convert"></i></button>
                                                                    </form>
                                                                </td>
                                                            </tr>
                                                            <?php $i++ ?>
