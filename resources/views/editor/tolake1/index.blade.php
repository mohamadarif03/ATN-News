...
<head>
    <meta charset="utf-8" />
    <title>Berita Ditolak | ATN News</title>
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Berita Yang itolak</li>
                                    </ol>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <div class="pb-3">
                                    <form class="d-flex" action="{{url('tolake1')}}" method="get">
                                                ...
                                                <table class="table table-bordered table-nowrap mb-0">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="col-md-2">Lihat Berita</th>
                                                        </tr>
                                                      </thead>
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>{{ $row->ditolak }}</td>
                                                          <td>
                                                            <a href="/edit_editor/{{ $row->id }}" class="btn btn-warning btn-sm"><i class="mdi mdi-pencil"></i></a>
                                                        </td>
