                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <div class="pb-3">
                                    <a href='/tambahkategori' class="btn btn-primary">+ Tambah Data</a>
                                </div>

                                <div class="pb-3">
                                    <form class="d-flex" action="{{ url('kategori_admin') }}" method="get">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($data as $row)
                                                            <tr>
                                                                ...
                                                                <td >{{ $row->deskripsi }}</td>
                                                                <td>
                                                                <img src="{{ asset('fotokategori/' . $row->fotokat) }}" alt="" style="width: 75px;">
                                                                </td>
                                                                <td>
                                                                    <a href="/tampilkategori/{{ $row->id }}"
                                                                        class="btn btn-info" style="color: white;"><i class="mdi mdi-pencil"></i></a>
                                                                    <a href="/deletekategori/{{ $row->id }}"
