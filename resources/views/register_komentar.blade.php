                            ...
                            <div class="card mb-0">
                                <div class="card-body p-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h5 class="text-muted text-uppercase py-3 font-16">Daftar</h5>
                                    </div>
                                    ...
                                    <form action="" method="POST" class="mt-2">
                                        ...
                                        <div class="form-group text-center">
                                            <button class="btn btn-success btn-block waves-effect waves-light" type="submit" id="submitBtn" disabled> Daftar </button>
                                        </div>
