...
<head>
    <meta charset="utf-8" />
    <title>Iklan | ATN News - Responsive Bootstrap 4 Admin Dashboard</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <div class="pb-3">
                                    <a href="/tambahiklan" class="btn btn-primary">+ Tambah Data</a>
                                </div>
                                <div class="pb-3">
                                <form class="d-flex" action="{{url('iklan')}}" method="get">
