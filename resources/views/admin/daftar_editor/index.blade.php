                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Daftar Editor</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Daftar Editor</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                                ...
                                                <table class="table table-nowrap">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Nama Editor</th>
                                                            <th>Berita Dibuat</th>
                                                            <th>Berita Ditolak</th>
                                                            <th>Berita Disetujui</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ count($row->tolak) }} </td>
                                                            <td>{{ count($row->diterima) }}</td>
                                                            <td>
                                                                <form onsubmit="return confirm('Yakin Ingin Menurunkan Jabatan PEngguna Ini?')" class="d-inline" action="/turunjabatan/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <button type="submit" style="color: white;" name="submit" class="btn btn-success"><i class="mdi mdi-arrow-expand-down"></i></button>
                                                                </form>
