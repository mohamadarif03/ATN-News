  ...
  margin: 10px;
        ...
        * {
        ...
        @font-face {
            ...
            src: url(../wp-content/themes/foxiz/assets/fonts/iconscb41.ttf?v=1.6.3) format("truetype"),
        ...
        .flex-dropdown {
            ...
            margin-top: 20px;
            cursor: auto;
            -webkit-transition: top 0s ease 0.25s,
        ...
        .box-border .list-box:before {
            ...
            border-color: var(--box-color,
                    var(--default-box, var(--flex-gray-15)));
            border-radius: var(--wrap-border, var(--round-3));
        }
        ...
        .box-bg .list-box {
            background-color: var(--box-color,
                    var(--default-box, var(--solid-light)));
        }

        .box-shadow .grid-box,
        .box-shadow .list-box {
            background-color: var(--box-color,
                    var(--default-box, transparent));
        ...
        .light-scheme .box-border .list-box:after {
            border-color: var(--dark-box-color,
        ...
        .light-scheme .box-shadow .list-box {
            background-color: var(--dark-box-color,
                    var(--default-dark-box, transparent));
        }
        ...
        .hover-ani-4 .p-url {
            ...
            background-image: -webkit-gradient(linear,
                    ...
                    from(var(--g-color-90)),
                    to(var(--g-color-90)));
            background-image: linear-gradient(var(--g-color-90),
                    var(--g-color-90));
            background-repeat: no-repeat;
        ...
        .hover-ani-5 .p-url {
            ...
            background-image: -webkit-gradient(linear,
                    ...
                    from(var(--g-color)),
                    to(var(--g-color)));
            background-image: linear-gradient(var(--g-color),
                    var(--g-color));
            background-repeat: no-repeat;
            background-position: 0 100%;
        ...
        .table-link-depth:before {
            content: counter(table-content) "."
                counter(table-content-subsection);
        ...
        .pattern-dot2:before {
            background-image: radial-gradient(var(--body-fcolor) 1px,
                    transparent 1px),
                radial-gradient(var(--body-fcolor) 1px,
                    var(--solid-white) 1px);
        ...
        @media (min-width: 768px) {
            ...
            .featured-left .list-box .p-featured {
                ...
                border-bottom-right-radius: 0;
                border-bottom-left-radius: var(--wrap-border,
                        var(--round-3));
            }
    ...
    <link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/1599.json" />
    ...
    <meta property="og:image" content="https://foxiz.themeruby.com/tech/wp-content/uploads/sites/3/2021/12/t40.jpg" />
    <meta property="og:type" content="article" />
    <meta property="article:published_time" content="2021-12-17T03:32:00+00:00" />
    <meta property="article:modified_time" content="2022-02-23T10:12:12+00:00" />
    <meta name="author" content="Connor" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:creator" content="@Technology" />
...
<body
                                                    ...
                                                    <div id="respond" class="comment-respond">
                                                        ...
                                                        <form action="/komentar/{{$data->id}}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <p class="comment-form-comment">
                                                                ...
                                                                <label for="komentar">Komentar Kamu&nbsp;<span class="required">*</span></label>
                                                                <textarea id="komentar" name="komentar" placeholder="Tinggalkan Komentar" cols="45" rows="8"></textarea>
                                                            </p>
                                                            ...
                                                            <div class="ubox">
                                                                ...
                                                                <div class="ubio description-text">
                                                                        ...
                                                                        <div class="d-flex">
                                                                             ...
                                                                             <span class="nname-info meta-author" style="margin-right: 9px">
                                    ...
                                    <div id="widget-post-2" class="widget rb-section w-sidebar clearfix widget-post" style="margin-top: 20px">
                                        ...
                                        <!-- <div class="usr-holder entry-sec">
                                            <div class="ubox">
                                                <div class="ubox-header">
                                                    <div class="author-info-wrap">
                                                        <a class="author-avatar"
                                                            href="../author/technology/index.html"><img
                                                                src="../wp-content/uploads/sites/3/2022/01/avatar-150x150.jpg"
                                                                width="120" height="120" alt="Connor"
                                                                class="avatar avatar-120 wp-user-avatar wp-user-avatar-120 alignnone photo"
                                                                loading="lazy" /></a>
                                                        <div class="is-meta">
                                                            <span class="nname-info meta-author">
                                                                ...
                                                                <a class="nice-name"
                                                                    href="../author/technology/index.html">Connor</a>
                                                            </span>
                                                            <span class="author-job">Senior
                                                                Editor</span>
                                                        </div>
                                                    </div>
                                                    <div class="usocials tooltips-n meta-text">
                                                        <span class="ef-label">Follow: </span><a
                                                            class="social-link-website" data-title="Website"
                                                            href="../index.html" target="_blank"
                                                            rel="noopener nofollow"><i
                                                                class="rbi rbi-portfolio-o"></i></a><a
                                                            class="social-link-facebook" data-title="Facebook" href="#"
                                                            target="_blank" rel="noopener nofollow"><i
                                                                class="rbi rbi-facebook"></i></a><a
                                                            class="social-link-skype" data-title="Skype" href="#"
                                                            target="_blank" rel="noopener nofollow"><i
                                                                class="rbi rbi-skype"></i></a><a
                                                            class="social-link-whatsapp" data-title="WhatsApp" href="#"
                                                            target="_blank" rel="noopener nofollow"><i
                                                ...
                                                <div class="ubio description-text">
                                                    ...
                                                    of Foxiz as a news
                                                    editor and content
                                                    creator. An artist by
                                                    nature who enjoys video
                                                    games, guitars, action
                                                    figures, cooking,
                                        ...
                                        <!-- <div class="entry-sec entry-pagination e-pagi mobile-hide">
                                            <div class="inner">
                                                <div class="nav-el nav-left">
                                                    <a
                                                        href="../are-smartwatches-the-future-of-wearable-devices/index.html">
                                                        <span class="nav-label is-meta">
                                                            <i class="rbi rbi-angle-left"></i><span>Previous
                                                                Article</span>
                                                        </span>
                                                        <span class="nav-inner">
                                                            <img width="150" height="150"
                                                                src="../wp-content/uploads/sites/3/2021/12/t12-150x150.jpg"
                                                                class="attachment-thumbnail size-thumbnail wp-post-image"
                                                                alt="" decoding="async" loading="lazy" />
                                                            <span class="h4"><span class="p-url">Are
                                                                    Smartwatches
                                                                    the
                                                                    Future
                                                                    of
                                        ...
                                        <div id="rb-user-reviews-1599"
                                            ...
                                            <div class="comment-box-header">
                                                <span class="h3"><svg class="svg-icon svg-feedback" aria-hidden="true"
                                                        role="img" focusable="false" viewBox="0 0 511 511.9996"
                                                        ...
                                                        <div id="respond" class="comment-respond">
                                                            <h3 id="reply-title" class="comment-reply-title">
                                                                ...
                                                                <small><a rel="nofollow" id="cancel-comment-reply-link"
                                                                        href="index.html#respond" style="
                                                                                display: none;
                                                                            ">Cancel
                                                                        reply</a></small>
                                                            </h3>
                                                            <form
                                                                action="https://foxiz.themeruby.com/tech/wp-comments-post.php"
                                                                ...
                                                                <p class="comment-notes">
                                                                    <span id="email-notes">Your
                                                                        ...
                                                                        be
                                                                        published.</span>
                                                                    <span class="required-field-message">Required
                                                                        fields
                                                                        are
                                                                        marked
                                                                ...
                                                                <div class="rb-form-rating">
                                                                    <span class="rating-alert is-hidden">Please
                                                                        select
                                                                        a
                                                                        rating!</span>
                                                                    <label for="rating-1599">Your
                                                                        Rating</label>
                                                                    <select name="rbrating" id="rating-1599"
                                                                        class="rb-rating-selection">
                                                                ...
                                                                <p class="comment-form-comment">
                                                                    <label for="comment">Your
                                                                        ...
                                                                        placeholder="Leave a comment" cols="45" rows="8"
                                                                        required></textarea>
                                                                </p>
                                                                <p class="comment-form-author">
                                                                    <label for="author">Your
                                                                        name&nbsp;<span
                                                                ...
                                                                <p class="comment-form-url">
                                                                    <label for="url">Your
                                                                        website</label><input placeholder="Your website"
                                                                        id="url" name="url" type="email" value=""
                                                                        size="30" />
                                                                </p>
                                                                ...
                                                                <p class="form-submit">
                                                                    <input name="submit" type="submit" id="submit"
                                                                        class="submit" value="Post a Review" />
                                                                    <input type="hidden" name="comment_post_ID"
                                                                        value="1599" id="comment_post_ID" />
    ...
    {{-- <footer class="footer-wrap rb-section left-dot">
        <div class="footer-inner footer-has-bg">
            <div class="footer-columns rb-columns is-gap-25 rb-container edge-padding footer-4c">
                    ...
                    <div class="footer-col">
                        <div id="text-2" class="widget w-sidebar rb-section clearfix widget_text">
                            <div class="textwidget">
                                <div class="h1" style="color: var(--global-color);margin-bottom: 10px">//</div>
                                <h4 class="footer-quote">Kami ATN Berita </h4>
                            </div>
                        </div>
                    </div>
                    <div class="footer-col">
                            ...
                            <div class="menu-footer-1-container">
                                <ul id="menu-footer-3" class="menu">
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1633">
                                        <a href="#"><span>PEMBERITAHUAN PRIVASI</span></a>
                                    </li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1634">
                                        <a href="#"><span>HAK PRIVASI ANDA</span></a>
                                    </li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1635">
                                        <a href="#"><span>IKLAN BERBASIS BUNGA<span
                                                    class="menu-sub-title meta-text">New</span></span></a>
                                    </li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1636">
                                        <a href="#"><span>SYARAT PENGGUNAAN</span></a>
                                    </li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1637">
                                        <a href="#"><span>PETA SITUS KAM</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="menu-footer-2-container">
                                <ul id="menu-footer-4" class="menu">
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1638">
                                        <a href="#"><span>MENGIKLANKAN</span></a>
                                    </li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1639">
                                        <a href="#"><span>TERBAIK ONLINE<span
                                                    class="menu-sub-title meta-text">Hot</span></span></a>
                                    </li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1640">
                                        <a href="#"><span>PELANGGAN</span></a>
                                    </li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1641">
                                        <a href="#"><span>JASA</span></a>
                                    </li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1642">
                                        <a href="#"><span>LANGGANAN</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div id="nav_menu-3" class="widget w-sidebar rb-section clearfix widget_nav_menu">
                            <div class="block-h widget-heading heading-layout-10">
                                <div class="heading-inner">
                                    ...
                                    <div style="margin-left: 10px;">anandaharfiana@gmail.com</div>
                                </div>
                                <div class="heading-inner">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                    ...
                                    <div style="margin-left: 10px;">@nandaahfn</div>
                                </div>
                                <div class="heading-inner">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                    ...
                                    <div style="margin-left: 10px;">0856743211</div>
                                </div>


                                <!-- <div class="footer-col">
                        <div id="text-3" class="widget w-sidebar rb-section clearfix widget_text">
                            <div class="block-h widget-heading heading-layout-10">
                                <div class="heading-inner">
                                    <h4 class="heading-title"><span>Contact Admin</span></h4>
                                </div>
                            </div>
                            <div class="textwidget">
                                <p class="entry-summary">Ayo yang mau demo ke admin silahkan klik kontak kami</p>
                                <script>
                                    (function() {
                                ...
                                <form id="mc4wp-form-2" class="mc4wp-form mc4wp-form-1616" method="post" data-id="1616" data-name="form">
                                    <div class="mc4wp-form-fields">
                                        <div> <input type="email" name="EMAIL" placeholder="Your email address" required /> <a href="/contact/kontak"></a> <input  type="submit" value="Contact Us" /></div>
                                         <button>Contact Us</button> 
                                    </div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1675686539" /><input type="hidden" name="_mc4wp_form_id" value="1616" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-2" />
                ...
                <div class="rb-container edge-padding">
                    <div class="bottom-footer-section"> <a class="footer-logo" href="index.html" title="Technology"> <img class="logo-default" data-mode="default" height="100" width="100" src="wp-content/uploads/sites/3/2022/01/footer-logo.png" alt="Technology" loading="lazy"><img class="logo-dark" data-mode="dark" height="100" width="100" src="wp-content/uploads/sites/3/2022/01/footer-logo.png" alt="Technology" loading="lazy"> </a>
    ...
    <!-- <div class="demos-quick-view">
        <div class="ruby-sale-icon">
            <a target="_blank" href="http://1.envato.market/MXYjYo"><img
                    src="../wp-content/plugins/foxiz-demos-selection-sale/sale.png" alt="sale off" loading="lazy" /></a>
        </div>
        <a class="quick-view-link quick-view-demos" href="https://foxiz.themeruby.com/demos/" target="_blank">
        ...
        <a class="quick-view-link quick-view-buy" target="_blank" href="http://1.envato.market/5bvdaj">
            <svg id="svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                width="400" height="400" viewBox="0, 0, 400,400">
                <g id="svgg">
                    <path id="path0"
