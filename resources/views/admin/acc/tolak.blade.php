                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Tolak</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Tolak Pengguna</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <form action="/fungsitolakuser/{{ $data->id }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        <div class="card-box">
                                            
                                        <div class="my-3 p-3 bg-body rounded shadow-sm">
                                            <div class="mb-3 row">
                                                <label for="jenis" class="col-sm-2 col-form-label">Nama Pengguna</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name='username' disabled value="{{$data->username}}">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="jenis" class="col-sm-2 col-form-label">Alasan Pengguna Ditolak</label>
                                                <div class="col-sm-10">
